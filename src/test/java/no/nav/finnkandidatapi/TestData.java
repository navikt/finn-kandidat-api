...
import static no.nav.finnkandidatapi.kandidat.ArbeidstidBehov.HELTID;
import static no.nav.finnkandidatapi.kandidat.ArbeidstidBehov.KAN_IKKE_JOBBE;
import static no.nav.finnkandidatapi.kandidat.FysiskBehov.ARBEIDSSTILLING;
import static no.nav.finnkandidatapi.kandidat.FysiskBehov.ERGONOMI;
import static no.nav.finnkandidatapi.kandidat.GrunnleggendeBehov.*;
