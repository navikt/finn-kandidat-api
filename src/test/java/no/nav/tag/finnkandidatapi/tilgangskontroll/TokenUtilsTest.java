...
import static no.nav.tag.finnkandidatapi.tilgangskontroll.TokenUtils.ISSUER_ISSO;
import static no.nav.tag.finnkandidatapi.tilgangskontroll.TokenUtils.ISSUER_SELVBETJENING;
