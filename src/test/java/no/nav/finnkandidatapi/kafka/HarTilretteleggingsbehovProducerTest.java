...
import no.nav.finnkandidatapi.kandidat.GrunnleggendeBehov;
...
public class HarTilretteleggingsbehovProducerTest {
    ...
    public void setUp() {
        ...
        when(tokenUtils.hentInnloggetVeileder()).thenReturn(TestData.enVeileder());
    }
    ...
    public void kandidatOppdatert__skal_sende_melding_på_kafka_topic() throws JSONException, JsonProcessingException {
        ...
        HarTilretteleggingsbehov harTilretteleggingsbehov = new HarTilretteleggingsbehov(TestData.enAktørId(), true, kategorier);
