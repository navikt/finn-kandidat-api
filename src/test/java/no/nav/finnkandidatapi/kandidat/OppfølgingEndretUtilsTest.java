...
import no.nav.finnkandidatapi.kafka.oppfølgingEndret.OppfølgingEndretUtils;
...
public class OppfølgingEndretUtilsTest {
    ...
    public void deserialiserMelding__skal_kaste_runtime_exception_hvis_fnr_er_null() {
        Oppfølgingsbruker meldingUtenFnr = new Oppfølgingsbruker(null, TestData.etNavKontor());
    ...
    public void deserialiserMelding__skal_fungere_hvis_navkontor_er_null() {
        Oppfølgingsbruker meldingUtenNavKontor = new Oppfølgingsbruker(TestData.etFnr(), null);
    ...
    public void deserialiserMelding__skal_deserialisere_gyldig_melding() {
        Oppfølgingsbruker oppfølgingsbruker = TestData.enOppfølgingsbruker();
